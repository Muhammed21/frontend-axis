                ...
                <CredenzaContent>
                  ...
                  <div className="grid gap-5 md:mx-0 mx-5 md:mb-0 mb-10 md:mt-0 mt-5">
                    ...
                    <Typographie size="h4" balise="h4" theme="gray">
                      * Une fois le paiement validé, sous peu, vous recevrez un
                      devis avec toutes les infos. nécessaire <br /> <br /> *
                      Tous vos paiements sont cryptés, avec le niveau de
                      Certification le plus stricte du secteur{" "}
